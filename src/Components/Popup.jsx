...
export default function Popup({ header, body }) {
  return (
   ...
   z-10 ml-[5vw] mt-[5vh] rounded-xl shadow-2xl backdrop-blur-xl border border-white/60 shadow-[0_20px_60px_rgba(0,0,0,0.25)] "
    >
      <div className="absolute top-5 right-5 text-3xl text-white cursor-pointer hover:text-red-500">
        <FaRectangleXmark />
      </div>
      <div className="w-[80vw] h-[80vh] text-center text-2xl text-black bg-white p-20 overflow-auto rounded-xl">
        <div className="flex justify-between mb-10">
          <button className="w-[10vw] h-[5vh] bg-[linear-gradient(to_bottom,#BBF26B_0%,#88C236_10%,#588515_50%,#3B590E_50%,#598513_70%,#AEED53_100%)] text-white border-solid border-white rounded-xl">
            Previous
          </button>
